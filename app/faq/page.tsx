                ...
                <div className={styles.side2}>
                    <Container>
                        ...
                        <Box
                            ...
                            description="HackIllinois is composed of five teams, who work closely together to create HackIllinois! <br/><br/> 1. The Experience Team organizes the logistics and operations behind our events, such as scheduling, mentor/judge outreach, and attendee amenities. During the event, they manage content ranging from workshops taught by industry professionals to events like the Poker tournament! <br/><br/> 2. The Outreach Team builds and maintains relationships with companies and corporate sponsors to effectively raise funding for HackIllinois. They also plan and execute company-sponsored events. Past sponsors include the likes of Fortune 500 companies and MAANG! <br/><br/> 3. The Systems Team handles the technology infrastructure for HackIllinois, including our website, mobile apps, and API. You can explore our past websites in the history section and download our latest Android and iOS apps from the Google Play Store and Apple App Store. <br/><br/> 4. The Design Team designs the brand, graphics, and UI/UX for HackIllinois media for posters, websites, mobile apps, and swag. You can catch them brainstorming in Figma or creating t-shirt mock-ups in Adobe Illustrator! <br/><br/> 5. The Marketing Team creates promotional content, collaborates with external organizations for increasing our event scope and audience, runs social media platforms, and oversees speaker outreach. Their overarching goal is to promote diversity and inclusion in HackIllinois. You can observe their handiwork in our Instagram and all event communications!"
                        />
                        <Box
