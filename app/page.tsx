        ...
        <div className="page">
            ...
            <div className="section-div">
                ...
                <div className="textbox">
                    <br></br>
                    <p className="p-text">
                        HackIllinois is the premiere student-run hackathon at
                        the University of Illinois at Urbana-Champaign. Each
                        Spring, HackIllinois hosts nearly a thousand students
                        who work together for a weekend to learn new skills and
                        technologies to create innovative hacks such as
                        websites, mobile apps, and many more!
                    </p>
            ...
            <div className="section-div">
                ...
                <div className="textbox">
                    <br></br>
                    <p className="p-text">
                        Our goal is to promote growth and collaboration among
                        both new and experienced programmers. The HackIllinois
                        team organize and plan events each year where students
                        can come together to create projects with their peers.
                        We strive to celebrate the innovative and creative
                        spirits of students nationwide!
                    </p>
                    ...
                    {data.map((team: listOfTeams) => (
                        <div className={styles.teamListItem}>
                            <Image
                                ...
                                alt={team.name}
                            />
                            <li className={styles.teamListItemText}>{team.name}</li>
                        </div>
                    ))}
                </ul>
                <Button backgroundColor={"#68C8BF"} textColor={"#FCE891"} text={"Meet the Teams"} />
                <div className="textbox">
                    <br></br>
                    <p className="p-text">
                        Our goal is to promote growth and collaboration among
